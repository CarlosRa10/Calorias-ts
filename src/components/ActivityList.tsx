...
export default function ActivityList({activities, dispatch}:ActivityListProps) {
    //con useMemo te evitas en tus templates tener el parentesis--le ponemos un segundo parametro
            ...
            activities.map(activity => (
                <div key={activity.id} className="px-5 py-10 bg-white mt-5 flex justify-between shadow">
                    ...
                    <div className="flex gap-5 items-center">
                            <button
                                //Como vas a pasar un parametro usamos la sintaxis de callback
